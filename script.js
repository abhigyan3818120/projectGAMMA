const TEACHERS = [
  ...
  linkedin: "https://www.linkedin.com/in/rajeev-ranjan-0ab49719/",
    ...
    function buildCard(person, isTeacher) {
      ...
      img.onerror = function () {
        artZone.classList.add('no-photo');
        img.classList.add('hidden-img');
      };

      artZone.appendChild(artGlow);
      artZone.appendChild(img);
    ...
    function openModal(person) {
      modalArt.src          = person.cover;
      modalArt.alt          = person.name;
      modalName.textContent = person.name;
      modalRole.textContent = person.role;
      instaLink.href = person.instagram || "#";
      linkedinLink.href = person.linkedin || "#";

      modalProps.innerHTML = '';
      person.props.forEach(p => {
